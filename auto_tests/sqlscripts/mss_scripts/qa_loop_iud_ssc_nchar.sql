...
While @v_del<1000
Begin
Delete from sp_ss.ssc_nchar where COL_NUMBER in ( @v_del + 100,4000-@v_del)
Delete from sp_ss.ssc_nchar_max where COL_NUMBER in ( @v_del + 100,4000-@v_del)
Set @v_del=@v_del+1
End
